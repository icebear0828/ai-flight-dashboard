...
从 [GitHub Releases](https://github.com/icebear0828/ai-flight-dashboard/releases/latest) 下载对应平台的压缩包。macOS 首次启动时，如果系统拦截未签名应用，请右键 `AI Flight Dashboard.app` 选择“打开”。
